#!/usr/bin/env python
# coding: utf-8
# Copyright (c) 2013-2019 Abram Hindle, Carlo Oliva
...
class Client:
    """
    Class Client taken from https://github.com/abramhindle/WebSocketsExamples/blob/master/chat.py
    """
...
def world():
    ...
    Taken from https://github.com/olivaC/CMPUT404-assignment-ajax
    :return: World
    """
...
def get_entity(entity):
    ...
    :return:
    """
    ent = jsonify(myWorld.get(entity))
    return ent
